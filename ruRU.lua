...
L["grease_bot_note"] = "Нажмите на бота, чтобы получить 5% скорости и 10% скорости передвижения на 2 часа."
L["shock_bot"] = "Шоковый бот"
L["shock_bot_note"] = "Нажмите на бота, чтобы получить возможность наносить дополнительный урон в течение 2 часов."
L["welding_bot"] = "Сварочный робот"
L["welding_bot_note"] = "Нажмите на бота, чтобы увеличить здоровье и получаемое исцеление, на 10% в течение 2 часов."

L["options_toggle_mech_buffs"] = "Баффы Ботов"
L["options_toggle_mech_buffs_desc"] = "Отображение местоположения смазочных, шоковых и сварочных ботов на карте внутри подземелья."
